...
#' @author Tim Fraser
get_qi_by_sensordate = function(path_data =  "../descriptives/panel_daily_nyc.rds", start = "2025-01-05", end = "2025-06-01"){

  # Testing values
  # path_data =  "../descriptives/panel_daily_nyc.rds"; start = "2025-01-05"; end = "2025-06-01"
  ...
  # Bundle Results
  stat = bind_rows(
    stat1 %>% mutate(model = "M9"), # CRZ
    stat2 %>% mutate(model = "M6"), # NYC
    stat3 %>% mutate(model = "M3") # CBSA
  ) %>%
